# Ecommerce: Promotions Core Module

> This package is the authoritative, provider-neutral implementation of Promotions. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-ecommerce-promotions?sort=semver)](https://github.com/liberusoftware/module-ecommerce-promotions/releases/latest) [![Tests](https://github.com/liberusoftware/module-ecommerce-promotions/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-ecommerce-promotions/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-ecommerce-promotions
```
...
<a href="https://github.com/liberusoftware/module-ecommerce-promotions/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-ecommerce-promotions" alt="Contributors to liberusoftware/module-ecommerce-promotions">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-ecommerce-promotions/graphs/contributors).
